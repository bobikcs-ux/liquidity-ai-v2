    ...
    <div className="max-w-7xl mx-auto space-y-6">
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <button className="p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors group">
                  <Share2 className="w-5 h-5 text-gray-600 group-hover:text-gray-900" />
                </button>
                <button className="flex items-center gap-2 px-4 py-3 bg-[#2563EB] text-white rounded-xl hover:bg-[#1d4ed8] transition-colors font-medium">
      ...
      <div className="flex items-center justify-between pt-6">
        ...
        <div className="flex items-center gap-2">
          <button className="w-10 h-10 rounded-xl bg-[#2563EB] text-white font-medium">1</button>
          <button className="w-10 h-10 rounded-xl hover:bg-gray-100 text-gray-700 font-medium">2</button>
          <button className="w-10 h-10 rounded-xl hover:bg-gray-100 text-gray-700 font-medium">3</button>
        </div>
